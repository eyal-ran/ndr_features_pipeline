...
def _build_if_training_step(
    *,
    ...
    dpp_config_table_name: ParameterString,
    mlp_config_table_name: ParameterString,
    ...
    evaluation_windows_json: ParameterString,
    missing_windows_override: ParameterString,
    enable_history_planner: ParameterString,
    enable_auto_remediate_15m: ParameterString,
    enable_auto_remediate_fgb: ParameterString,
    enable_post_training_evaluation: ParameterString,
    enable_eval_join_publication: ParameterString,
    enable_eval_experiments_logging: ParameterString,
    stage: str,
...
def build_if_training_pipeline(
    ...
    dpp_config_table_name = ParameterString(name="DppConfigTableName", default_value="<required:DppConfigTableName>")
    mlp_config_table_name = ParameterString(name="MlpConfigTableName", default_value="<required:MlpConfigTableName>")
    batch_index_table_name = ParameterString(name="BatchIndexTableName", default_value="<required:BatchIndexTableName>")
    ...
    evaluation_windows_json = ParameterString(name="EvaluationWindowsJson", default_value="[]")
    missing_windows_override = ParameterString(name="MissingWindowsOverride", default_value="[]")
    enable_history_planner = ParameterString(name="EnableHistoryPlanner", default_value="true")
    enable_auto_remediate_15m = ParameterString(name="EnableAutoRemediate15m", default_value="true")
    enable_auto_remediate_fgb = ParameterString(name="EnableAutoRemediateFgb", default_value="true")
    enable_post_training_evaluation = ParameterString(name="EnablePostTrainingEvaluation", default_value="true")
    enable_eval_join_publication = ParameterString(name="EnableEvalJoinPublication", default_value="true")
    enable_eval_experiments_logging = ParameterString(name="EnableEvalExperimentsLogging", default_value="true")
    ...
    verifier_step = _build_if_training_step(
        ...
        evaluation_windows_json=evaluation_windows_json,
        missing_windows_override=missing_windows_override,
        enable_history_planner=enable_history_planner,
        enable_auto_remediate_15m=enable_auto_remediate_15m,
        enable_auto_remediate_fgb=enable_auto_remediate_fgb,
        enable_post_training_evaluation=enable_post_training_evaluation,
        enable_eval_join_publication=enable_eval_join_publication,
        enable_eval_experiments_logging=enable_eval_experiments_logging,
        stage="verify",
    )
