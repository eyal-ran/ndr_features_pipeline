...
class JobSpecLoader:
    ...
    The table is expected to have a primary key on (project_name, job_name_version)
    ...
    def __init__(self, table_name: str | None = None):
        ...
        self._table_name = resolve_dpp_config_table_name(table_name)
